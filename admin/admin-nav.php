...
<nav class="admin-nav">
    ...
    <div class="admin-nav-links">
        ...
        <a href="episodes.php"   class="<?= $cur==='episodes.php'   ?'active':'' ?>">Afleveringen</a>
        <a href="lore.php"       class="<?= $cur==='lore.php'       ?'active':'' ?>">Lore</a>
        <a href="gallery.php"    class="<?= $cur==='gallery.php'    ?'active':'' ?>">Gallery</a>
        <a href="find-replace.php" class="<?= $cur==='find-replace.php' ?'active':'' ?>" style="color:var(--gold);">🔍 Zoek &amp; Vervang</a>
